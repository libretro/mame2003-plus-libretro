...
enum
{
  OPT_FRAMESKIP = 0,
  OPT_INPUT_INTERFACE,
  OPT_RETROPAD1_LAYOUT,
  OPT_RETROPAD2_LAYOUT,
  OPT_RETROPAD3_LAYOUT,
  OPT_RETROPAD4_LAYOUT,
  OPT_RETROPAD5_LAYOUT,
  OPT_RETROPAD6_LAYOUT,
  OPT_MOUSE_DEVICE,
...
#define PAD_GAMEPAD RETRO_DEVICE_SUBCLASS(RETRO_DEVICE_JOYPAD, 0)
...
#define PAD_CLASSIC RETRO_DEVICE_SUBCLASS(RETRO_DEVICE_JOYPAD, 3)
