...
// Gekirindan (Translation To China)(Ver 2.3J 1995/09/21) 逆鳞弹中文版
ROM_START( gekiridoc )
	ROM_REGION(0x200000, REGION_CPU1, 0) /* 68020 code */
...
ROM_START( cleopatrs01 )
	...
	ROM_REGION16_BE(0x400000, REGION_SOUND1 , ROMREGION_SOUNDONLY | ROMREGION_ERASE00 ) // V2: 4 banks, only 1 populated
	ROM_LOAD16_BYTE("e28-03.bin", 0x000000, 0x200000, CRC(15c7989d) SHA1(7cc63d93e5c1f9f52f889e973bbefd5e6f7ce807) )
ROM_END
...
GAME( 200?, gekiridoc, gekiridn, f3,      f3,  gekirido, ROT270, "Taito Corporation", "Gekirindan (Translation To China)(Ver 2.3J 1995/09/21)" )
GAME( 200?, pbobl2xh,  pbobble2, f3,      f3,  pbobbl2x, ROT0,   "Unknown",     "Puzzle Bobble 2X (Hack)(Ver 2.3O 1995/07/31)" )
