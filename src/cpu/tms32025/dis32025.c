...
int main(int argc,char *argv[])
{
	...
	if(argc<2)
	{
		...
		log_cb(RETRO_LOG_INFO, LOGPRE "TMS32025 Disassembler 1.1 by Tony La Porta (C)2001-2002+\n\n");
		log_cb(RETRO_LOG_INFO, LOGPRE "Usage: dis32025 <input-file> [ <start-addr> [ <num-of-addr> ] ]\n");
