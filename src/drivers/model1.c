...
INPUT_PORTS_START( wingwar )
	PORT_START	/* X */
	PORT_ANALOG( 0xff, 0x80, IPT_AD_STICK_X | IPF_REVERSE, 100, 4, 0x00, 0xff )

	PORT_START	/* Y */
	PORT_ANALOG( 0xff, 0x80, IPT_AD_STICK_Y, 100, 4, 0x00, 0xff )

	PORT_START	/* Throttle */
	PORT_ANALOG( 0xff, 0x00, IPT_PEDAL, 150, 150, 1, 0xff )
...
INPUT_PORTS_START( swa )
	...
	PORT_START	/* Throttle */
	PORT_ANALOG( 0xff, 228, IPT_PEDAL|IPF_REVERSE, 150, 150, 28, 228 )
