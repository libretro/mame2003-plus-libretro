...
READ_HANDLER( sraider_sound_low_r )
{
...
READ_HANDLER( sraider_sound_high_r )
{
	return sraider_sound_high;
}

WRITE_HANDLER( sraider_sound_low_w )
{
	sraider_sound_low = data;
}

WRITE_HANDLER( sraider_sound_high_w )
{
...
WRITE_HANDLER( sraider_grid_data_w )
{
	static int x = 0;
