...
INPUT_PORTS_START( ssf2 )
    ...
    PORT_START      /* IN1 (0x10) */
    PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER1 ) /* weak kick */
    PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_BUTTON4 | IPF_PLAYER1 ) /* medium kick */
    PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_BUTTON6 | IPF_PLAYER1 ) /* fierce kick */
    PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_UNKNOWN )
