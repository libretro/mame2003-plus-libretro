...
ROM_START( slipstrm )
	...
	ROM_REGION( 0x0400000, REGION_GFX2, 0 ) /* sprites */
...
GAMEX(1994, jleague,  svf,      system32, svf,      jleague,  ROT0, "Sega", "The J.League 1994 (Japan)", GAME_NOT_WORKING | GAME_UNEMULATED_PROTECTION )
