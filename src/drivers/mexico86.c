...
ROM_START( kikikais01 )
	...
	ROM_LOAD( "knightb.uc", 0x0000, 0x0800, CRC(3cc2bbe4) SHA1(af018a1e0655b66fd859617a3bd0c01a4967c0e6) )
	//Use ROMset from MAME 0.78, because the HBMAME ROMset has none.
...
GAME( 200?, kikikais01,  kikikai, kikikai,  kikikai,0, ROT90, "Unknown",  "KiKi KaiKai (Translation Chinese)")
