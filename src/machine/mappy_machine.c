...
READ_HANDLER( mappy_customio_1_r )
{
	...
	log_cb(RETRO_LOG_DEBUG, LOGPRE "I/O read 1: mode %d offset %d\n", mode, offset);
...
READ_HANDLER( mappy_customio_2_r )
{
	...
	log_cb(RETRO_LOG_DEBUG, LOGPRE "I/O read 2: mode %d, offset %d\n", mappy_customio_2[8], offset);
...
READ_HANDLER( todruaga_customio_1_r )
{
	...
	log_cb(RETRO_LOG_DEBUG, LOGPRE "%04x: I/O read 1: mode %d offset %d\n", activecpu_get_pc(), mode, offset);
...
READ_HANDLER( todruaga_customio_2_r )
{
	...
	log_cb(RETRO_LOG_DEBUG, LOGPRE "%04x: I/O read 2: mode %d, offset %d\n", activecpu_get_pc(), mode, offset);
