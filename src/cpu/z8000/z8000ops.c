...
{
	GET_IMM8(0);
	log_cb(RETRO_LOG_DEBUG, LOGPRE "Z8K#%d %04x: ext0e  $%02x\n", cpu_getactivecpu(), PC, imm8);
    if (FCW & F_EPU) {
...
{
	GET_IMM8(0);
	log_cb(RETRO_LOG_DEBUG, LOGPRE "Z8K#%d %04x: ext0f  $%02x\n", cpu_getactivecpu(), PC, imm8);
    if (FCW & F_EPU) {
		/* Z8001 EPU code goes here */
		(void)imm8;
    }
...
{
	GET_IMM8(0);
	log_cb(RETRO_LOG_DEBUG, LOGPRE "Z8K#%d %04x: rsvd36 $%02x\n", cpu_getactivecpu(), PC, imm8);
    if (FCW & F_EPU) {
		/* Z8001 EPU code goes here */
		(void)imm8;
    }
...
{
	GET_IMM8(0);
	log_cb(RETRO_LOG_DEBUG, LOGPRE "Z8K#%d %04x: rsvd38 $%02x\n", cpu_getactivecpu(), PC, imm8);
    if (FCW & F_EPU) {
		/* Z8001 EPU code goes here */
		(void)imm8;
    }
...
{
	GET_IMM8(0);
	log_cb(RETRO_LOG_DEBUG, LOGPRE "Z8K#%d %04x: rsvd78 $%02x\n", cpu_getactivecpu(), PC, imm8);
    if (FCW & F_EPU) {
		/* Z8001 EPU code goes here */
		(void)imm8;
    }
...
static void Z7B_0000_0000(void)
{
	...
	CHANGE_FCW(fcw);		 /* check for user/system mode change */
    change_pc16bew(PC);
	log_cb(RETRO_LOG_DEBUG, LOGPRE "Z8K#%d IRET tag $%04x, fcw $%04x, pc $%04x\n", cpu_getactivecpu(), tag, fcw, PC);
}
...
static void Z7D_dddd_0ccc(void)
{
	...
	switch (imm3) {
		...
		case 7:
			...
			break;
		default:
			log_cb(RETRO_LOG_DEBUG, LOGPRE "Z8K#%d LDCTL R%d,%d\n", cpu_getactivecpu(), dst, imm3);
    }
}
...
static void Z7D_ssss_1ccc(void)
{
	...
	switch (imm3) {
		...
		case 7:
			...
			break;
		default:
			log_cb(RETRO_LOG_DEBUG, LOGPRE "Z8K#%d LDCTL %d,R%d\n", cpu_getactivecpu(), imm3, src);
    }
}
...
{
	GET_IMM8(0);
	log_cb(RETRO_LOG_DEBUG, LOGPRE "Z8K#%d %04x: rsvd7e $%02x\n", cpu_getactivecpu(), PC, imm8);
    if (FCW & F_EPU) {
		/* Z8001 EPU code goes here */
		(void)imm8;
    }
...
{
	GET_IMM8(0);
	log_cb(RETRO_LOG_DEBUG, LOGPRE "Z8K#%d %04x: ext8e  $%02x\n", cpu_getactivecpu(), PC, imm8);
    if (FCW & F_EPU) {
		/* Z8001 EPU code goes here */
		(void)imm8;
    }
...
{
	GET_IMM8(0);
	log_cb(RETRO_LOG_DEBUG, LOGPRE "Z8K#%d %04x: ext8f  $%02x\n", cpu_getactivecpu(), PC, imm8);
    if (FCW & F_EPU) {
		/* Z8001 EPU code goes here */
		(void)imm8;
    }
...
{
	GET_IMM8(0);
	log_cb(RETRO_LOG_DEBUG, LOGPRE "Z8K#%d %04x: rsvd9d $%02x\n", cpu_getactivecpu(), PC, imm8);
    if (FCW & F_EPU) {
		/* Z8001 EPU code goes here */
		(void)imm8;
    }
...
{
	GET_IMM8(0);
	log_cb(RETRO_LOG_DEBUG, LOGPRE "Z8K#%d %04x: rsvd9f $%02x\n", cpu_getactivecpu(), PC, imm8);
    if (FCW & F_EPU) {
		/* Z8001 EPU code goes here */
		(void)imm8;
    }
...
{
	GET_IMM8(0);
	log_cb(RETRO_LOG_DEBUG, LOGPRE "Z8K#%d %04x: rsvdb9 $%02x\n", cpu_getactivecpu(), PC, imm8);
    if (FCW & F_EPU) {
		/* Z8001 EPU code goes here */
		(void)imm8;
    }
...
{
	GET_IMM8(0);
	log_cb(RETRO_LOG_DEBUG, LOGPRE "Z8K#%d %04x: rsvdbf $%02x\n", cpu_getactivecpu(), PC, imm8);
    if (FCW & F_EPU) {
		/* Z8001 EPU code goes here */
		(void)imm8;
    }
