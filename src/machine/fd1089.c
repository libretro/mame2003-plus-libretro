...
void fd1089a_decrypt(void)
{
	sys16_decrypt( (data8_t *)memory_region(REGION_USER2), FD1089A);
}

void fd1089b_decrypt(void)
{
	sys16_decrypt( (data8_t *)memory_region(REGION_USER2), FD1089B);
}
