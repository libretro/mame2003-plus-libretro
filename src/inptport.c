...
struct ipd inputport_defaults[] =
{
...
#ifdef MESS
	{ IPT_UI_TOGGLE_UI,         "UI Toggle",			SEQ_DEF_1(KEYCODE_F10) },
#endif
	...
	{ IPT_UI_CANCEL,            "UI Cancel",			SEQ_DEF_4(KEYCODE_LSHIFT, KEYCODE_ESC, CODE_OR, JOYCODE_1_BUTTON1) },
	{ IPT_UI_ADD_CHEAT,         "Add Cheat",			SEQ_DEF_2(KEYCODE_LSHIFT, KEYCODE_A) },
	{ IPT_UI_DELETE_CHEAT,		"Delete Cheat",			SEQ_DEF_2(KEYCODE_LSHIFT, KEYCODE_D) },
	{ IPT_UI_SAVE_CHEAT,		"Save Cheat",			SEQ_DEF_2(KEYCODE_LSHIFT, KEYCODE_S) },
	{ IPT_UI_WATCH_VALUE,		"Watch Value",			SEQ_DEF_2(KEYCODE_LSHIFT, KEYCODE_W) },
	{ IPT_UI_EDIT_CHEAT,		"Edit Cheat",			SEQ_DEF_2(KEYCODE_LSHIFT, KEYCODE_E) },
