...
static struct Samplesinterface mk_samples_yunit =
{
	2,	/* 2 channels*/
	100, /* volume*/
	mk_sample_names_yunit
};
...
INPUT_PORTS_START( trog )
	...
	PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_COIN1 )
	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_COIN2 )
	PORT_BIT_IMPULSE( 0x0004, IP_ACTIVE_LOW, IPT_START1, 1 )
	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_TILT ) /* Slam Switch */
	PORT_BITX(0x0010, IP_ACTIVE_LOW, IPT_SERVICE | IPF_TOGGLE, "Test", KEYCODE_F2, IP_JOY_NONE )
	PORT_BIT_IMPULSE( 0x0020, IP_ACTIVE_LOW, IPT_START2, 1 )
	PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_SERVICE1 )
	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_COIN3 )
	PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_UNUSED ) /* video freeze */
	PORT_BIT_IMPULSE( 0x0200, IP_ACTIVE_LOW, IPT_START3, 1 )
	PORT_BIT_IMPULSE( 0x0400, IP_ACTIVE_LOW, IPT_START4, 1 )
