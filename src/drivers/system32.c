...
static READ16_HANDLER ( sys32_gun_p1_x_c00050_r ) { int retdata; retdata = sys32_gun_p1_x_c00050_data | 0x7f; sys32_gun_p1_x_c00050_data = (sys32_gun_p1_x_c00050_data<<1)*1.2; usrintf_showmessage("port:%i  game:%i", readinputport(7), sys32_gun_p1_x_c00050_data); return retdata; }
