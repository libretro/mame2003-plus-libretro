...
static WRITE_HANDLER( vsnes_coin_counter_w )
{
	...
	{
		/*do something?*/
		log_cb(RETRO_LOG_DEBUG, LOGPRE "vsnes_coin_counter_w: pc = 0x%04x - data = 0x%02x\n", activecpu_get_pc(), data);
	}
}
...
static WRITE_HANDLER( vsnes_coin_counter_1_w )
{
	...
	{
		/*do something?*/
		log_cb(RETRO_LOG_DEBUG, LOGPRE "vsnes_coin_counter_1_w: pc = 0x%04x - data = 0x%02x\n", activecpu_get_pc(), data);
	}
...
/* Hacks from HBMAME 0.202 */
GAME( 2002, drmarios01,  drmario,	vsnes,   drmario,  drmario,  ROT0, "liujunusa", "Vs. Dr. Mario (Translation Chinese)(2002-10)" )
GAME( 2002, mrio2002, suprmrio,		vsnes,   suprmrio, suprmrio, ROT0, "Nintendo",  "Vs. Super Mario Bros. 2002" )
GAME( 1986, suprsktr, suprmrio,		vsnes,   suprmrio, suprmrio, ROT0, "Nintendo",  "Vs. Super Skater Bros." )
