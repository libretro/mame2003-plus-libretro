	...
	switch (customio_command & 0x0f)
	{
		...
		case 0x08:
			if (offset == 6)
			{
				...
				{
					log_cb(RETRO_LOG_DEBUG, LOGPRE "%04x: custom IO offset %02x\n",activecpu_get_pc(),offset);
					log_cb(RETRO_LOG_DEBUG, LOGPRE "data[0]=%02x\n",customio[0]);
					log_cb(RETRO_LOG_DEBUG, LOGPRE "data[1]=%02x\n",customio[1]);
					log_cb(RETRO_LOG_DEBUG, LOGPRE "data[2]=%02x\n",customio[2]);
					log_cb(RETRO_LOG_DEBUG, LOGPRE "data[3]=%02x\n",customio[3]);
					log_cb(RETRO_LOG_DEBUG, LOGPRE "data[4]=%02x\n",customio[4]);
					log_cb(RETRO_LOG_DEBUG, LOGPRE "data[5]=%02x\n",customio[5]);
					log_cb(RETRO_LOG_DEBUG, LOGPRE "data[6]=%02x\n",customio[6]);
				}
			}
			break;
	}
...
READ_HANDLER( xevious_customio_data_r )
{
	if (customio_command != 0x71)
		log_cb(RETRO_LOG_DEBUG, LOGPRE "%04x: custom IO read offset %02x\n",activecpu_get_pc(),offset);
...
{
	log_cb(RETRO_LOG_DEBUG, LOGPRE "CPU0 %04x: custom I/O Read = %02x\n",activecpu_get_pc(),battles_customio_command);
...
READ_HANDLER( battles_customio3_r )
{
	...
	log_cb(RETRO_LOG_DEBUG, LOGPRE "CPU3 %04x: custom I/O Read = %02x\n",activecpu_get_pc(),return_data);
...
{
	log_cb(RETRO_LOG_DEBUG, LOGPRE "CPU0 %04x: custom I/O Write = %02x\n",activecpu_get_pc(),data);
...
{
	log_cb(RETRO_LOG_DEBUG, LOGPRE "CPU3 %04x: custom I/O Write = %02x\n",activecpu_get_pc(),data);
...
{
	log_cb(RETRO_LOG_DEBUG, LOGPRE "CPU0 %04x: custom I/O parameter %02x Read = %02x\n",activecpu_get_pc(),offset,battles_customio_data);
...
{
	log_cb(RETRO_LOG_DEBUG, LOGPRE "CPU3 %04x: custom I/O parameter %02x Read = %02x\n",activecpu_get_pc(),offset,battles_customio_data);
	return battles_customio_data;
}
...
{
	log_cb(RETRO_LOG_DEBUG, LOGPRE "CPU0 %04x: custom I/O parameter %02x Write = %02x\n",activecpu_get_pc(),offset,data);
...
{
	log_cb(RETRO_LOG_DEBUG, LOGPRE "CPU3 %04x: custom I/O parameter %02x Write = %02x\n",activecpu_get_pc(),offset,data);
	battles_customio_data = data;
}
...
{
	log_cb(RETRO_LOG_DEBUG, LOGPRE "CPU3 %04x: 40%02x Write = %02x\n",activecpu_get_pc(),offset,data);
...
{
	log_cb(RETRO_LOG_DEBUG, LOGPRE "CPU3 %04x: 50%02x Write = %02x\n",activecpu_get_pc(),offset,data);
...
{
	log_cb(RETRO_LOG_DEBUG, LOGPRE "battles_input_port_r %04x: Read offset %02x\n",activecpu_get_pc(),offset);
	return 0xff;
}
