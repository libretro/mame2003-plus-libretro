...
#define generate_ost_sound_ddragon()		\
{		\
	int a = 0;		\
...
#define generate_ost_sound_ffight()		\
{		\
	switch (data) {		\
...
#define generate_ost_sound_mk_tunit()		\
{		\
	int a = 0;		\
	bool mk_do_nothing = false;		\
	bool sa_play_sample = false;		\
...
#define generate_ost_sound_moonwalker()		\
{		\
	int a = 0;		\
...
#define generate_ost_sound_nba_jam()		\
{		\
	int a = 0;		\
...
#define generate_ost_sound_outrun()		\
{		\
	int a = 0;		\
	int o_max_samples = 12;		\
	int sa_left = 0;		\
