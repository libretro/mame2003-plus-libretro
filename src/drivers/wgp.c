...
{
	log_cb(RETRO_LOG_DEBUG, LOGPRE "CPU #2 PC %06x: warning - read lan status\n",activecpu_get_pc());
...
log_cb(RETRO_LOG_DEBUG, LOGPRE "CPU #0 PC %06x: warning - read unmapped a/d input offset %06x\n",activecpu_get_pc(),offset);
