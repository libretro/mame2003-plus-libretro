...
struct ipd inputport_defaults[] =
{
  ...
  { IPT_UI_UP,                "UI Up",          SEQ_DEF_5(KEYCODE_UP,    CODE_OR, JOYCODE_1_UP,      CODE_OR, JOYCODE_2_HAT_UP) },
  { IPT_UI_DOWN,              "UI Down",        SEQ_DEF_5(KEYCODE_DOWN,  CODE_OR, JOYCODE_1_DOWN,    CODE_OR, JOYCODE_2_HAT_DOWN) },
  { IPT_UI_LEFT,              "UI Left",        SEQ_DEF_5(KEYCODE_LEFT,  CODE_OR, JOYCODE_1_LEFT,    CODE_OR, JOYCODE_2_HAT_LEFT) },
  { IPT_UI_RIGHT,             "UI Right",       SEQ_DEF_5(KEYCODE_RIGHT, CODE_OR, JOYCODE_1_RIGHT,   CODE_OR, JOYCODE_2_HAT_RIGHT) },
  ...
  { IPT_JOYSTICK_UP         | IPF_PLAYER1, "P1 Up",          SEQ_DEF_5(KEYCODE_UP,       CODE_OR, JOYCODE_1_UP,     CODE_OR,   JOYCODE_1_HAT_UP)   },
  { IPT_JOYSTICK_DOWN       | IPF_PLAYER1, "P1 Down",        SEQ_DEF_5(KEYCODE_DOWN,     CODE_OR, JOYCODE_1_DOWN,   CODE_OR,   JOYCODE_1_HAT_DOWN) },
  { IPT_JOYSTICK_LEFT       | IPF_PLAYER1, "P1 Left",        SEQ_DEF_5(KEYCODE_LEFT,     CODE_OR, JOYCODE_1_LEFT,   CODE_OR,   JOYCODE_1_HAT_LEFT) },
  { IPT_JOYSTICK_RIGHT      | IPF_PLAYER1, "P1 Right",       SEQ_DEF_5(KEYCODE_RIGHT,    CODE_OR, JOYCODE_1_RIGHT,  CODE_OR,   JOYCODE_1_HAT_RIGHT)},
  ...
  { IPT_JOYSTICK_UP         | IPF_PLAYER2, "P2 Up",          SEQ_DEF_5(KEYCODE_R, CODE_OR, JOYCODE_2_UP,      CODE_OR, JOYCODE_2_HAT_UP)   },
  { IPT_JOYSTICK_DOWN       | IPF_PLAYER2, "P2 Down",        SEQ_DEF_5(KEYCODE_F, CODE_OR, JOYCODE_2_DOWN,    CODE_OR, JOYCODE_2_HAT_DOWN) },
  { IPT_JOYSTICK_LEFT       | IPF_PLAYER2, "P2 Left",        SEQ_DEF_5(KEYCODE_D, CODE_OR, JOYCODE_2_LEFT,    CODE_OR, JOYCODE_2_HAT_LEFT) },
  { IPT_JOYSTICK_RIGHT      | IPF_PLAYER2, "P2 Right",       SEQ_DEF_5(KEYCODE_G, CODE_OR, JOYCODE_2_RIGHT,   CODE_OR, JOYCODE_2_HAT_RIGHT)},
  ...
  { IPT_JOYSTICK_UP         | IPF_PLAYER3, "P3 Up",          SEQ_DEF_5(KEYCODE_I, CODE_OR, JOYCODE_3_UP,      CODE_OR, JOYCODE_3_HAT_UP)    },
  { IPT_JOYSTICK_DOWN       | IPF_PLAYER3, "P3 Down",        SEQ_DEF_5(KEYCODE_K, CODE_OR, JOYCODE_3_DOWN,    CODE_OR, JOYCODE_3_HAT_DOWN)  },
  { IPT_JOYSTICK_LEFT       | IPF_PLAYER3, "P3 Left",        SEQ_DEF_5(KEYCODE_J, CODE_OR, JOYCODE_3_LEFT,    CODE_OR, JOYCODE_3_HAT_LEFT)  },
  { IPT_JOYSTICK_RIGHT      | IPF_PLAYER3, "P3 Right",       SEQ_DEF_5(KEYCODE_L, CODE_OR, JOYCODE_3_RIGHT,   CODE_OR, JOYCODE_3_HAT_RIGHT) },
  ...
  { IPT_JOYSTICK_UP         | IPF_PLAYER4, "P4 Up",          SEQ_DEF_3(JOYCODE_4_UP,      CODE_OR, JOYCODE_4_HAT_UP) },
  { IPT_JOYSTICK_DOWN       | IPF_PLAYER4, "P4 Down",        SEQ_DEF_3(JOYCODE_4_DOWN,    CODE_OR, JOYCODE_4_HAT_DOWN) },
  { IPT_JOYSTICK_LEFT       | IPF_PLAYER4, "P4 Left",        SEQ_DEF_3(JOYCODE_4_LEFT,    CODE_OR, JOYCODE_4_HAT_LEFT) },
  { IPT_JOYSTICK_RIGHT      | IPF_PLAYER4, "P4 Right",       SEQ_DEF_3(JOYCODE_4_RIGHT,   CODE_OR, JOYCODE_4_HAT_RIGHT) },
