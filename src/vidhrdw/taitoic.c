...
#if 0
if (data & 0xff00)
{ log_cb(RETRO_LOG_ERROR, LOGPRE "CPU #0 PC %06x: warning - write %02x to MSB of TC0360PRI address %02x\n",activecpu_get_pc(),data,offset); }
	else
{ log_cb(RETRO_LOG_ERROR, LOGPRE "CPU #0 PC %06x: warning - write %02x to MSB of TC0360PRI address %02x\n",activecpu_get_pc(),data,offset); }
#endif
	}
...
#if 0
if (data & 0xff)
{ log_cb(RETRO_LOG_ERROR, LOGPRE "CPU #0 PC %06x: warning - write %02x to LSB of TC0360PRI address %02x\n",activecpu_get_pc(),data,offset); }
	else
{ log_cb(RETRO_LOG_ERROR, LOGPRE "CPU #0 PC %06x: warning - write %02x to LSB of TC0360PRI address %02x\n",activecpu_get_pc(),data,offset); }
#endif
	}
...
READ16_HANDLER( TC0110PCR_word_r )
{
	switch (offset)
	{
		...
		default:
log_cb(RETRO_LOG_ERROR, LOGPRE "PC %06x: warning - read TC0110PCR address %02x\n",activecpu_get_pc(),offset);
			return 0xff;
	}
}
...
READ16_HANDLER( TC0110PCR_word_1_r )
{
	switch (offset)
	{
		...
		default:
log_cb(RETRO_LOG_ERROR, LOGPRE "PC %06x: warning - read second TC0110PCR address %02x\n",activecpu_get_pc(),offset);
			return 0xff;
	}
}
...
READ16_HANDLER( TC0110PCR_word_2_r )
{
	switch (offset)
	{
		...
		default:
log_cb(RETRO_LOG_ERROR, LOGPRE "PC %06x: warning - read third TC0110PCR address %02x\n",activecpu_get_pc(),offset);
			return 0xff;
	}
}
...
WRITE16_HANDLER( TC0110PCR_word_w )
{
	switch (offset)
	{
		...
		default:
log_cb(RETRO_LOG_ERROR, LOGPRE "PC %06x: warning - write %04x to TC0110PCR address %02x\n",activecpu_get_pc(),data,offset);
			break;
	}
}
...
WRITE16_HANDLER( TC0110PCR_step1_word_1_w )
{
	switch (offset)
	{
		...
		default:
log_cb(RETRO_LOG_ERROR, LOGPRE "PC %06x: warning - write %04x to second TC0110PCR offset %02x\n",activecpu_get_pc(),data,offset);
			break;
	}
}
...
WRITE16_HANDLER( TC0110PCR_step1_word_2_w )
{
	switch (offset)
	{
		...
		default:
log_cb(RETRO_LOG_ERROR, LOGPRE "PC %06x: warning - write %04x to third TC0110PCR offset %02x\n",activecpu_get_pc(),data,offset);
			break;
	}
}
...
WRITE16_HANDLER( TC0110PCR_step1_rbswap_word_w )
{
	...
	switch (offset)
	{
		...
		default:
log_cb(RETRO_LOG_ERROR, LOGPRE "PC %06x: warning - write %04x to TC0110PCR offset %02x\n",activecpu_get_pc(),data,offset);
			break;
	}
}
...
READ_HANDLER( TC0220IOC_r )
{
	switch (offset)
	{
		...
		default:
log_cb(RETRO_LOG_ERROR, LOGPRE "PC %06x: warning - read TC0220IOC address %02x\n",activecpu_get_pc(),offset);
			return 0xff;
	}
}
...
/*logerror("PC %06x: warning - write %02x to TC0220IOC address %02x\n",activecpu_get_pc(),data,offset);*/
		...
		default:
log_cb(RETRO_LOG_ERROR, LOGPRE "PC %06x: warning - write %02x to TC0220IOC address %02x\n",activecpu_get_pc(),data,offset);
			break;
	}
}
...
log_cb(RETRO_LOG_ERROR, LOGPRE "CPU #0 PC %06x: warning - write to MSB of TC0220IOC address %02x\n",activecpu_get_pc(),offset);
	}
}
...
log_cb(RETRO_LOG_ERROR, LOGPRE "CPU #0 PC %06x: warning - write to LSB of TC0220IOC address %02x\n",activecpu_get_pc(),offset);
	}
}
...
READ_HANDLER( TC0510NIO_r )
{
	switch (offset)
	{
		...
		default:
log_cb(RETRO_LOG_ERROR, LOGPRE "PC %06x: warning - read TC0510NIO address %02x\n",activecpu_get_pc(),offset);
			return 0xff;
	}
}
...
WRITE_HANDLER( TC0510NIO_w )
{
	...
	switch (offset)
	{
		...
		default:
log_cb(RETRO_LOG_ERROR, LOGPRE "PC %06x: warning - write %02x to TC0510NIO address %02x\n",activecpu_get_pc(),data,offset);
			break;
	}
}
...
log_cb(RETRO_LOG_ERROR, LOGPRE "CPU #0 PC %06x: warning - write to MSB of TC0510NIO address %02x\n",activecpu_get_pc(),offset);
...
READ_HANDLER( TC0640FIO_r )
{
	switch (offset)
	{
		...
		default:
log_cb(RETRO_LOG_ERROR, LOGPRE "PC %06x: warning - read TC0640FIO address %02x\n",activecpu_get_pc(),offset);
			return 0xff;
	}
}
...
WRITE_HANDLER( TC0640FIO_w )
{
	...
	switch (offset)
	{
		...
		default:
log_cb(RETRO_LOG_ERROR, LOGPRE "PC %06x: warning - write %02x to TC0640FIO address %02x\n",activecpu_get_pc(),data,offset);
			break;
	}
}
...
log_cb(RETRO_LOG_ERROR, LOGPRE "CPU #0 PC %06x: warning - write to MSB of TC0640FIO address %02x\n",activecpu_get_pc(),offset);
	}
}
...
WRITE16_HANDLER( TC0640FIO_halfword_byteswap_w )
{
	...
	{
		TC0640FIO_w(offset,data & 0xff);
log_cb(RETRO_LOG_ERROR, LOGPRE "CPU #0 PC %06x: warning - write to LSB of TC0640FIO address %02x\n",activecpu_get_pc(),offset);
	}
}
