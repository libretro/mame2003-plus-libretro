...
ROM_START( sk3p1 )
	...
	ROM_REGION( 0x8000, REGION_GFX2, 0 )
	ROM_COPY( REGION_GFX1, 0x000000, 0x000000, 0x8000 )	
...
// Sangokushi 3 Gaiden Kakou-On'S Revence Dx 2010 (Set 07)
ROM_START( sk3p10 )
	ROM_REGION( CODE_SIZE, REGION_CPU1, 0 )
...
// Sangokushi II (Chinese Translation)(Asia 921005)
ROM_START( sk2h14 )
	ROM_REGION( CODE_SIZE, REGION_CPU1, 0 )
...
// Tenchi wo Kurau II (Three Boss Edition)(Japan 921031)
ROM_START( tk2h118 )
	ROM_REGION( CODE_SIZE, REGION_CPU1, 0 ) 
...
// Tenchi wo Kurau II (Warriors of Fate Plus 2 2018)(Japan 921031)"
ROM_START( tk2h108 )
	ROM_REGION( CODE_SIZE, REGION_CPU1, 0 )
...
GAME( 2010, sk3p1,	wofch,    qsound,     wofch,   	wof,      ROT0,   "Katana", "Sangokushi 3 Gaiden Kakou-on's Revenge DX 2010 (Red)" )
GAME( 2010, sk3p2,	wofch,    qsound,     wofch,	wof,      ROT0,   "Katana", "Sangokushi 3 Gaiden Kakou-on's Revenge DX 2010 (Green set 1)" )
GAME( 2010, sk3p3,	wofch,    qsound,     wofch,	wof,      ROT0,   "Katana", "Sangokushi 3 Gaiden Kakou-on's Revenge DX 2010 (Green set 2)" )
GAME( 2010, sk3p7,	wofch,    qsound,     wofch,	wof,      ROT0,   "Katana", "Sangokushi 3 Gaiden Kakou-On S Revence Dx 2010 (Set 04)" )
GAME( 2010, sk3p8,	wofch,    qsound,     wofch,	wof,      ROT0,   "Katana", "Sangokushi 3 Gaiden Kakou-On S Revence Dx 2010 (Set 05)" )
GAME( 2018, sk3p9,	wofch,    qsound,     wofch,	wof,      ROT0,   "Katana", "Sangokushi 3 Gaiden Kakou-On's Revenge Dx 2010 (Set 06)" )
GAME( 1994, tk2p2,	wofch,    qsound,     wofch,	wof,      ROT0,   "Big West", "Tenchi wo Kurau II (Lock Triple Mode)(CPS Changer, Japan 921031)" )
GAME( 2010, tk2p3,	wofch,    qsound,     wofch,	wof,      ROT0,   "Pipi899", "Tenchi Wo Kurau II (Imitation Sword Invincible Version)(2010-01-29)(CPS Changer, Japan 921031)" )
GAME( 200?, wofchs01,      wofch,    qsound,     wofch,    wof,      ROT0,   "King Of Destruction", "Tenchi wo Kurau II (Imitation Sword Invincible Version)(Japan 921031)" )
GAME( 200?, wofchs02,      wofch,    qsound,     wofch,    wof,      ROT0,   "Katana", "Tenchi wo Kurau II (Boss Rush)(Japan 921031)" )
GAME( 200?, wofchs03,      wofch,    qsound,     wofch,    wof,      ROT0,   "Katana", "Tenchi wo Kurau II (Boss Rush Extreme)(Japan 921031)" )
GAME( 200?, wofchs04,      wofch,    qsound,     wofch,    wof,      ROT0,   "King of Destruction", "Tenchi wo Kurau II (Mode Plus)(Japan 921031)" )
GAME( 200?, wofchs05,      wofch,    qsound,     wofch,    wof,      ROT0,   "King of Destruction", "Tenchi wo Kurau II (A key to enter the mode)(Japan 921031)" )
GAME( 200?, wofchs06,      wofch,    qsound,     wofch,    wof,      ROT0,   "invincibility & winux", "Tenchi wo Kurau II (Hell Difficulty)(Japan 921031)" )
GAME( 200?, wofchs07,      wofch,    qsound,     wofch,    wof,      ROT0,   "Katana", "Tenchi wo Kurau II (True Purgatory Edition)(Japan 921031)" )
GAME( 200?, wofchs08,      wofch,    qsound,     wofch,    wof,      ROT0,   "tcwlee", "Tenchi wo Kurau II (Open Mode)(Japan 921031)" )
GAME( 200?, wofchs09,      wofch,    qsound,     wofch,    wof,      ROT0,   "tcwlee", "Tenchi wo Kurau II (Skull And Grass)(Japan 921031)" )
GAME( 200?, wofchs10,      wofch,    qsound,     wofch,    wof,      ROT0,   "Katana", "Tenchi wo Kurau II (Sangokushi III Gaiden: Kakou-on's Revenge)(Japan 921031)" )
GAME( 200?, wofchs11,      wofch,    qsound,     wofch,    wof,      ROT0,   "Katana", "Tenchi wo Kurau II (Sangokushi III Gaiden: Kakou-on's Revenge DX)(Japan 921031)" )
GAME( 200?, wofchs12,      wofch,    qsound,     wofch,    wof,      ROT0,   "Unknown", "Tenchi wo Kurau II (Sangokushi III Part 2)(Japan 921031)" )
GAME( 200?, wofchs13,      wofch,    qsound,     wofch,    wof,      ROT0,   "Katana", "Tenchi wo Kurau II (Sangokushi III Gaiden: Kakou-on's Revenge)(Alt)(Japan 921031)" )
GAME( 200?, wofchs14,      wofch,    qsound,     wofch,    wof,      ROT0,   "winuxx", "Tenchi wo Kurau II (Zhao Yunsheng Long Edition)(Japan 921031)" )
GAME( 2010, wofchs15,      wofch,    qsound,     wofch,    wof,      ROT0,   "kakakawa", "Tenchi wo Kurau II (Zhang Feiwu)(2010-08-21)(Japan 921031)" )
GAME( 200?, wofchs16,      wofch,    qsound,     wofch,    wof,      ROT0,   "kakakawa", "Tenchi wo Kurau II (Zhang Fei Vampire Edition)(2010-11-12)(Japan 921031)" )
GAME( 200?, wofchs17,      wofch,    qsound,     wofch,    wof,      ROT0,   "winux", "Tenchi wo Kurau II (Zhao Yun Movement Changes)(2010-08-21)(Japan 921031)" )
GAME( 200?, wofchs18,      wofch,    qsound,     wofch,    wof,      ROT0,   "gaoshihung", "Tenchi wo Kurau II (Zhang Fei Moves To Simplify)(Japan 921031)" )
GAME( 2013, wofchs19,      wofch,    qsound,     wofch,    wof,      ROT0,   "axdx", "Tenchi wo Kurau II (Extra Mode ON)(2013-03-19)(Japan 921031)" )
GAME( 2013, wofchs20,      wofch,    qsound,     wofch,    wof,      ROT0,   "axdx", "Tenchi wo Kurau II (Easy Control-Kassar-Super Spinning Pile Driver (A))(2013-03-19)(Japan 921031)" )
GAME( 2013, wofchs21,      wofch,    qsound,     wofch,    wof,      ROT0,   "axdx", "Tenchi wo Kurau II (Kassar-Super Spinning Pile Driver (+A))(2013-03-19)(Japan 921031)" )
GAME( 2013, wofchs22,      wofch,    qsound,     wofch,    wof,      ROT0,   "axdx", "Tenchi wo Kurau II (Kassar-Super Spinning Pile Driver (-A))(2013-03-19)(Japan 921031)" )
GAME( 2013, wofchs23,      wofch,    qsound,     wofch,    wof,      ROT0,   "axdx", "Tenchi wo Kurau II (Kassar-Viper Halberd-Super Spinning Pile Driver)(2013-03-19)(Japan 921031)" )
GAME( 2013, wofchs24,      wofch,    qsound,     wofch,    wof,      ROT0,   "axdx", "Tenchi wo Kurau II (Kassar-Grabbing-Super Spinning Pile Driver)(2013-03-19)(Japan 921031)" )
GAME( 2013, wofchs25,      wofch,    qsound,     wofch,    wof,      ROT0,   "axdx", "Tenchi wo Kurau II (Kassar-Midair Grabbing Simplified)(2013-03-19)(Japan 921031)" )
GAME( 2013, wofchs26,      wofch,    qsound,     wofch,    wof,      ROT0,   "axdx", "Tenchi wo Kurau II (Kassar-Unlimited Super Spinning Pile Driver)(2013-03-19)(Japan 921031)" )
GAME( 200?, wofchs27,      wofch,    qsound,     wofch,    wof,      ROT0,   "gaoshihung", "Tenchi wo Kurau II (Guan Yu's Big Move Improved)(Japan 921031)" )
GAME( 200?, wofchs28,      wofch,    qsound,     wofch,    wof,      ROT0,   "gaoshihung", "Tenchi wo Kurau II (Wei Yan Ordinary Drop Cancellation)(Japan 921031)" )
GAME( 200?, wofchs29,      wofch,    qsound,     wofch,    wof,      ROT0,   "gaoshihung", "Tenchi wo Kurau II (Wei Yan Empty Into A Big Seat)(Japan 921031)" )
GAME( 200?, wofchs30,      wofch,    qsound,     wofch,    wof,      ROT0,   "gaoshihung", "Tenchi wo Kurau II (Open Space To Strengthen The First Edition)(Japan 921031)" )
GAME( 200?, wofchs31,      wofch,    qsound,     wofch,    wof,      ROT0,   "gaoshihung", "Tenchi wo Kurau II (Open space Enhanced Second Edition)(Japan 921031)" )
GAME( 200?, wofchs33,      wofch,    qsound,     wofch,    wof,      ROT0,   "gaoshihung", "Tenchi wo Kurau II (Zhao Yun Sheng Long Lie broke)(Japan 921031)" )
GAME( 200?, wofchs34,      wofch,    qsound,     wofch,    wof,      ROT0,   "gaoshihung", "Tenchi wo Kurau II (Add Kassar's Super Punch)(Japan 921031)" )
GAME( 200?, wofchs35,      wofch,    qsound,     wofch,    wof,      ROT0,   "gaoshihung", "Tenchi wo Kurau II (Wei Yanchao killed More)(Japan 921031)" )
GAME( 200?, wofchs36,      wofch,    qsound,     wofch,    wof,      ROT0,   "Katana", "Tenchi wo Kurau II (Boss Rush Extreme)(Alt)(Japan 921031)" )
GAME( 200?, wofchs37,      wofch,    qsound,     wofch,    wof,      ROT0,   "winux", "Tenchi wo Kurau II (Many Boss)(Japan 921031)" )
GAME( 200?, wofchs38,      wofch,    qsound,     wofch,    wof,      ROT0,   "Katana", "Tenchi wo Kurau II (Kakou-on's Revenge-Prologue)(Japan 921031)" )
GAME( 2010, wofchs39,      wofch,    qsound,     wofch,    wof,      ROT0,   "kawada7278", "Tenchi wo Kurau II (Zhang Fei Vampire Edition)(Alt)(2010-11-12)(Japan 921031)" )
GAME( 2010, wofchs40,      wofch,    qsound,     wofch,    wof,      ROT0,   "Big front", "Tenchi wo Kurau II (BT Enhanced Edition)(2010-09-08)(Japan 921031)" )
GAME( 200?, wofchs41,      wofch,    qsound,     wofch,    wof,      ROT0,   "tcwlee", "Tenchi wo Kurau II (Enhanced mode)(Japan 921031)" )
GAME( 200?, wofchs42,      wofch,    qsound,     wofch,    wof,      ROT0,   "Katana/winuxx", "Tenchi wo Kurau II (Many Boss)(Alt)(Japan 921031)" )
GAME( 200?, wofchs43,      wofch,    qsound,     wofch,    wof,      ROT0,   "Unknown", "Tenchi wo Kurau II (Juggernauts)(Japan 921031)" )			
GAME( 2010, sk3p4,		wofch,      qsound,     wofch,		wof,      ROT0,   	"Katana", "Sangokushi 3 Gaiden Kakou-On'S Revence Dx 2010 (Set 01)" )
GAME( 2010, sk3p5,		wofch,      qsound,     wofch,		wof,      ROT0,   	"Katana", "Sangokushi 3 Gaiden Kakou-On'S Revence Dx 2010 (Set 02)" )
GAME( 2010, sk3p6,		wofch,      qsound,     wofch,		wof,      ROT0,   	"Katana", "Sangokushi 3 Gaiden Kakou-On'S Revence Dx 2010 (Set 03)" )
GAME( 2015, sk3p10,		wofch,      qsound,     wofch,		wof,      ROT0,   	"Katana", "Sangokushi 3 Gaiden Kakou-On's Revenge Dx 2010 (Set 07)" )
GAME( 2017, sk2h45,		wofch,      qsound,     wofch,		wof,      ROT0,   	"Katana", "Sangokushi 3 Gaiden Kakou-On's Revenge Dx 2010 (Set unknown)" )
/* Hacks of Tenchi wo Kurau II: Sekiheki no Tatakai (CPS) */
GAME( 200?, sk2h14,		wof,      	qsound,     wof,		wof,      ROT0,   	"Phoenix", "Sangokushi II (Chinese Translation)" )
GAME( 200?, tk2h118,	wof,      	qsound,     wof,		wof,      ROT0,   	"Unknown", "Tenchi wo Kurau II (Three Boss Edition)" )
GAME( 2018, tk2h108,	wof,      	qsound,     wof,		wof,      ROT0,   	"Unknown", "Tenchi wo Kurau II (Warriors of Fate Plus 2 2018)" )
GAME( 2009, tk2h12,		wof,      	qsound,     wof,		wof,      ROT0,   	"Rockywall", "Tenchi wo Kurau II (Playstation Version hack)(2009-12-09)" )
GAME( 2018, tk2h110,	wof,      	qsound,     wof,		wof,      ROT0,		"Bindi", "Tenchi wo Kurau II (Master Edition Ver.1)" )
GAME( 2018, tk2h120,	wof,      	qsound,     wof,		wof,      ROT0,		"Bindi", "Tenchi wo Kurau II (Master Edition Ver.2)" )
GAME( 2018, tk2h122,	wof,      	qsound,     wof,		wof,      ROT0,		"Bindi", "Tenchi wo Kurau II (Master Edition Ver.3)" )
GAME( 2018, tk2h123,	wof,      	qsound,     wof,		wof,      ROT0,		"Bindi", "Tenchi wo Kurau II (Li Dian Master Edition)" )
GAME( 2013, tk2h10,		wof,      	qsound,     wof,		wof,      ROT0,		"AXDX",	"Tenchi wo Kurau II (Sanmei Spiral Counterattack Beta 103)(2013-12-26)" )
GAME( 2018, tk2h101,	wof,      	qsound,     wof,		wof,      ROT0,		"Bindi", "Tenchi wo Kurau II (War Wolf Edition)" )
