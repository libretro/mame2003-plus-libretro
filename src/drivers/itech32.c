...
ROM_START( gt3d )	/* Version 1.93N for the single large type PCB P/N 1082 Rev 2 */
	...
	ROM_REGION( 0x8000, REGION_CPU1, 0 ) /* correct.?? */

    ROM_REGION32_BE( CODE_SIZE, REGION_USER1, ROMREGION_DISPOSE ) /* correct.?? */
...
static DRIVER_INIT( aama )
{
	...
	*/
	...
	init_program_rom();
	/*init_sound_speedup(0x2011, ????); Not sure of the address */
	itech32_vram_height = 1024;
	itech32_planes = 2;
	is_drivedge = 0;
