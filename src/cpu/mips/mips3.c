...
/*printf("mips3_execute (PC=%08X)\n", mips3.pc);*/
	...
	do
	{
		...
		switch (op >> 26)
		{
			...
			case 0x30:	/* LL */		log_cb(RETRO_LOG_WARN, LOGPRE "mips3 Unhandled op: LL\n");									break;
			...
			case 0x34:	/* LLD */		log_cb(RETRO_LOG_WARN, LOGPRE "mips3 Unhandled op: LLD\n");									break;
			...
			case 0x38:	/* SC */		log_cb(RETRO_LOG_WARN, LOGPRE "mips3 Unhandled op: SC\n");									break;
			...
			case 0x3c:	/* SCD */		log_cb(RETRO_LOG_WARN, LOGPRE "mips3 Unhandled op: SCD\n");									break;
