...
/* The "PIV" chip seems to be a renamed TC0100SCN. It has a
   ...
   serve some blending pupose ? */
	...
	{
		draw_crosshair( bitmap, ((255 - readinputport(3)) * Machine->drv->screen_width) / 255, ((readinputport(4)) * Machine->drv->screen_height) / 255, cliprect );
		draw_crosshair( bitmap, ((255 - readinputport(5)) * Machine->drv->screen_width) / 255, ((readinputport(6)) * Machine->drv->screen_height) / 255, cliprect );
	}
