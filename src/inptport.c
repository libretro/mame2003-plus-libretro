...
struct ipd inputport_defaults[] =
{
  ...
  { IPT_JOYSTICKLEFT_UP     | IPF_PLAYER1, "P1 Left/Up",     SEQ_DEF_7(KEYCODE_E,        CODE_OR, JOYCODE_1_LEFT_UP,     CODE_OR, JOYCODE_1_UP,     CODE_OR, JOYCODE_GUN_1_DPAD_UP    ) },
  { IPT_JOYSTICKLEFT_DOWN   | IPF_PLAYER1, "P1 Left/Down",   SEQ_DEF_7(KEYCODE_D,        CODE_OR, JOYCODE_1_LEFT_DOWN,   CODE_OR, JOYCODE_1_DOWN,   CODE_OR, JOYCODE_GUN_1_DPAD_DOWN  ) },
  { IPT_JOYSTICKLEFT_LEFT   | IPF_PLAYER1, "P1 Left/Left",   SEQ_DEF_7(KEYCODE_S,        CODE_OR, JOYCODE_1_LEFT_LEFT,   CODE_OR, JOYCODE_1_LEFT,   CODE_OR, JOYCODE_GUN_1_DPAD_LEFT  ) },
  { IPT_JOYSTICKLEFT_RIGHT  | IPF_PLAYER1, "P1 Left/Right",  SEQ_DEF_7(KEYCODE_F,        CODE_OR, JOYCODE_1_LEFT_RIGHT,  CODE_OR, JOYCODE_1_RIGHT,  CODE_OR, JOYCODE_GUN_1_DPAD_RIGHT ) },
  ...
  { IPT_JOYSTICKLEFT_UP     | IPF_PLAYER2, "P2 Left/Up",     SEQ_DEF_5(JOYCODE_2_LEFT_UP,     CODE_OR, JOYCODE_3_UP,    CODE_OR, JOYCODE_GUN_2_DPAD_UP )    },
  { IPT_JOYSTICKLEFT_DOWN   | IPF_PLAYER2, "P2 Left/Down",   SEQ_DEF_5(JOYCODE_2_LEFT_DOWN,   CODE_OR, JOYCODE_3_DOWN,  CODE_OR, JOYCODE_GUN_2_DPAD_DOWN )  },
  { IPT_JOYSTICKLEFT_LEFT   | IPF_PLAYER2, "P2 Left/Left",   SEQ_DEF_5(JOYCODE_2_LEFT_LEFT,   CODE_OR, JOYCODE_3_LEFT,  CODE_OR, JOYCODE_GUN_2_DPAD_LEFT )  },
  { IPT_JOYSTICKLEFT_RIGHT  | IPF_PLAYER2, "P2 Left/Right",  SEQ_DEF_5(JOYCODE_2_LEFT_RIGHT,  CODE_OR, JOYCODE_3_RIGHT, CODE_OR, JOYCODE_GUN_2_DPAD_RIGHT ) },
