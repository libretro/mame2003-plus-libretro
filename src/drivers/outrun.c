...
PORT_START	/* DSW1 */
	...
	PORT_DIPNAME( 0x30, 0x30, "Time Adjust" )
	PORT_DIPSETTING(    0x20, "Easy" )
	PORT_DIPSETTING(    0x30, "Normal" )
	PORT_DIPSETTING(    0x10, "Hard" )
	PORT_DIPSETTING(    0x00, "Hardest" )
...
GAME( 1989, toutrun,  0,        toutrun,  toutrun,  toutrun,  ROT0,         "Sega",    "Turbo Out Run (set 1)" ) /* decrypted */
GAME( 1989, toutruna, toutrun,  toutrun,  toutruna, toutrun,  ROT0,         "Sega",    "Turbo Out Run (set 2)" ) /* decrypted */
