...
struct ipd inputport_defaults_digital[] =
{
   ...
   { IPT_COIN1,  "P1 Coin",  SEQ_DEF_1(JOYCODE_1_SELECT) },
   { IPT_COIN2,  "P2 Coin",  SEQ_DEF_1(JOYCODE_2_SELECT) },
   { IPT_COIN3,  "P3 Coin",  SEQ_DEF_1(JOYCODE_3_SELECT) },
   { IPT_COIN4,  "P4 Coin",  SEQ_DEF_1(JOYCODE_4_SELECT) },
   ...
   { IPT_JOYSTICKLEFT_UP     | IPF_PLAYER4, "P4 Left/Up",     SEQ_DEF_1(JOYCODE_4_UP) },
   { IPT_JOYSTICKLEFT_DOWN   | IPF_PLAYER4, "P4 Left/Down",   SEQ_DEF_1(JOYCODE_4_DOWN) },
   { IPT_JOYSTICKLEFT_LEFT   | IPF_PLAYER4, "P4 Left/Left",   SEQ_DEF_1(JOYCODE_4_LEFT) },
   { IPT_JOYSTICKLEFT_RIGHT  | IPF_PLAYER4, "P4 Left/Right",  SEQ_DEF_1(JOYCODE_4_RIGHT) },
...
struct ipd inputport_defaults_analog[] =
{
   ...
   { IPT_BUTTON9             | IPF_PLAYER4, "P4 Button 9",    SEQ_DEF_0 },
   { IPT_BUTTON10            | IPF_PLAYER4, "P4 Button 10",   SEQ_DEF_0 },
   { IPT_JOYSTICKRIGHT_UP    | IPF_PLAYER4, "P4 Right/Up",    SEQ_DEF_1(JOYCODE_4_RIGHT_UP) },
   { IPT_JOYSTICKRIGHT_DOWN  | IPF_PLAYER4, "P4 Right/Down",  SEQ_DEF_1(JOYCODE_4_RIGHT_DOWN) },
   { IPT_JOYSTICKRIGHT_LEFT  | IPF_PLAYER4, "P4 Right/Left",  SEQ_DEF_1(JOYCODE_4_RIGHT_LEFT) },
   { IPT_JOYSTICKRIGHT_RIGHT | IPF_PLAYER4, "P4 Right/Right", SEQ_DEF_1(JOYCODE_4_RIGHT_RIGHT) },
   { IPT_JOYSTICKLEFT_UP     | IPF_PLAYER4, "P4 Left/Up",     SEQ_DEF_1(JOYCODE_4_LEFT_UP) },
   { IPT_JOYSTICKLEFT_DOWN   | IPF_PLAYER4, "P4 Left/Down",   SEQ_DEF_1(JOYCODE_4_LEFT_DOWN) },
   { IPT_JOYSTICKLEFT_LEFT   | IPF_PLAYER4, "P4 Left/Left",   SEQ_DEF_1(JOYCODE_4_LEFT_LEFT) },
   { IPT_JOYSTICKLEFT_RIGHT  | IPF_PLAYER4, "P4 Left/Right",  SEQ_DEF_1(JOYCODE_4_LEFT_RIGHT) },
   ...
   {  IPT_PEDAL                | IPF_PLAYER1, "P1 Pedal 1",            SEQ_DEF_1(JOYCODE_1_BUTTON6) },
   { (IPT_PEDAL+IPT_EXTENSION) | IPF_PLAYER1, "P1 Auto Release <Y/N>", SEQ_DEF_1(KEYCODE_Y) },
   {  IPT_PEDAL                | IPF_PLAYER2, "P2 Pedal 1",            SEQ_DEF_1(JOYCODE_2_BUTTON6) },
   { (IPT_PEDAL+IPT_EXTENSION) | IPF_PLAYER2, "P2 Auto Release <Y/N>", SEQ_DEF_1(KEYCODE_Y) },
   {  IPT_PEDAL                | IPF_PLAYER3, "P3 Pedal 1",            SEQ_DEF_1(JOYCODE_3_BUTTON6) },
   { (IPT_PEDAL+IPT_EXTENSION) | IPF_PLAYER3, "P3 Auto Release <Y/N>", SEQ_DEF_1(KEYCODE_Y) },
   ...
   { (IPT_PEDAL2+IPT_EXTENSION) | IPF_PLAYER4, "P4 Auto Release <Y/N>", SEQ_DEF_1(KEYCODE_Y) },
   {  IPT_PEDAL2                | IPF_PLAYER5, "P5 Pedal 2",            SEQ_DEF_0 },
   { (IPT_PEDAL2+IPT_EXTENSION) | IPF_PLAYER5, "P5 Auto Release <Y/N>", SEQ_DEF_1(KEYCODE_Y) },
   {  IPT_PEDAL2                | IPF_PLAYER6, "P6 Pedal 2",            SEQ_DEF_0 },
   { (IPT_PEDAL2+IPT_EXTENSION) | IPF_PLAYER6, "P6 Auto Release <Y/N>", SEQ_DEF_1(KEYCODE_Y) },
   {  IPT_PEDAL2                | IPF_PLAYER7, "P7 Pedal 2",            SEQ_DEF_0 },
   { (IPT_PEDAL2+IPT_EXTENSION) | IPF_PLAYER7, "P7 Auto Release <Y/N>", SEQ_DEF_1(KEYCODE_Y) },
   {  IPT_PEDAL2                | IPF_PLAYER8, "P8 Pedal 2",            SEQ_DEF_0 },
   { (IPT_PEDAL2+IPT_EXTENSION) | IPF_PLAYER8, "P8 Auto Release <Y/N>", SEQ_DEF_1(KEYCODE_Y) },

   {  IPT_PADDLE | IPF_PLAYER1,                "Paddle 1",      SEQ_DEF_1(JOYCODE_1_LEFT_LEFT)  },
   { (IPT_PADDLE | IPF_PLAYER1)+IPT_EXTENSION, "Paddle 1",      SEQ_DEF_1(JOYCODE_1_LEFT_RIGHT) },
   {  IPT_PADDLE | IPF_PLAYER2,                "Paddle 2",      SEQ_DEF_1(JOYCODE_2_LEFT_LEFT)  },
   { (IPT_PADDLE | IPF_PLAYER2)+IPT_EXTENSION, "Paddle 2",      SEQ_DEF_1(JOYCODE_2_LEFT_RIGHT) },
   {  IPT_PADDLE | IPF_PLAYER3,                "Paddle 3",      SEQ_DEF_1(JOYCODE_3_LEFT_LEFT)  },
   { (IPT_PADDLE | IPF_PLAYER3)+IPT_EXTENSION, "Paddle 3",      SEQ_DEF_1(JOYCODE_3_LEFT_RIGHT) },
   ...
   {  IPT_PADDLE_V | IPF_PLAYER1,                "Paddle V 1",      SEQ_DEF_1(JOYCODE_1_LEFT_UP) },
   { (IPT_PADDLE_V | IPF_PLAYER1)+IPT_EXTENSION, "Paddle V 1",      SEQ_DEF_1(JOYCODE_1_LEFT_DOWN) },
   {  IPT_PADDLE_V | IPF_PLAYER2,                "Paddle V 2",      SEQ_DEF_1(JOYCODE_2_LEFT_UP) },
   { (IPT_PADDLE_V | IPF_PLAYER2)+IPT_EXTENSION, "Paddle V 2",      SEQ_DEF_1(JOYCODE_2_LEFT_DOWN) },
   {  IPT_PADDLE_V | IPF_PLAYER3,                "Paddle V 3",      SEQ_DEF_1(JOYCODE_3_LEFT_UP) },
   { (IPT_PADDLE_V | IPF_PLAYER3)+IPT_EXTENSION, "Paddle V 3",      SEQ_DEF_1(JOYCODE_3_LEFT_DOWN) },
  ...
  { IPT_AD_STICK_Z | IPF_PLAYER1, "AD Stick Z",    SEQ_DEF_1(JOYCODE_1_RIGHT_UP)},
  { (IPT_AD_STICK_Z | IPF_PLAYER1)+IPT_EXTENSION,                "AD Stick Z",   SEQ_DEF_1(JOYCODE_1_RIGHT_DOWN) },
  { IPT_AD_STICK_Z | IPF_PLAYER2, "AD Stick Z 2", SEQ_DEF_1(JOYCODE_1_RIGHT_UP) },
  { (IPT_AD_STICK_Z | IPF_PLAYER2)+IPT_EXTENSION,                "AD Stick Z 2", SEQ_DEF_0 },
  { IPT_AD_STICK_Z | IPF_PLAYER3, "AD Stick Z 3", SEQ_DEF_0 },
  { (IPT_AD_STICK_Z | IPF_PLAYER3)+IPT_EXTENSION,                "AD Stick Z 3", SEQ_DEF_0 },
  { IPT_AD_STICK_Z | IPF_PLAYER4, "AD Stick Z 4", SEQ_DEF_0 },
