...
struct ipd inputport_defaults[] =
{
  ...
  { IPT_UI_UP,                "UI Up",          SEQ_DEF_5(KEYCODE_UP,    CODE_OR, JOYCODE_1_UP,      CODE_OR, JOYCODE_1_HAT_UP) },
  { IPT_UI_DOWN,              "UI Down",        SEQ_DEF_5(KEYCODE_DOWN,  CODE_OR, JOYCODE_1_DOWN,    CODE_OR, JOYCODE_1_HAT_DOWN) },
  { IPT_UI_LEFT,              "UI Left",        SEQ_DEF_5(KEYCODE_LEFT,  CODE_OR, JOYCODE_1_LEFT,    CODE_OR, JOYCODE_1_HAT_LEFT) },
  { IPT_UI_RIGHT,             "UI Right",       SEQ_DEF_5(KEYCODE_RIGHT, CODE_OR, JOYCODE_1_RIGHT,   CODE_OR, JOYCODE_1_HAT_RIGHT) },
